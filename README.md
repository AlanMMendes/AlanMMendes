...
Acredito que a tecnologia é uma ferramenta poderosa, mas o que realmente faz a diferença é entender o fluxo da operação e o impacto que o código causa na ponta. Minha base técnica é em **React.js, Nest.js e Oracle SQL** **(*ou qualquer coisa orientada a objetos*...)**, mas meu diferencial está na capacidade de ouvir stakeholders **(*e a operação*...)**, traduzir necessidades complexas e arquitetar soluções que funcionam sem *outage* **(*eu gosto de ver o que eu crio funcionando*)**.
...
Um dos projetos recentes que me orgulho de ter liderado **(*e que me deu uma baita dor de cabeça, mas ganhei conhecimento além do que eu esperava*)** foi um módulo de **Gestão de Vencimentos e Auditorias**. Através de um trabalho de escuta ativa com as áreas de negócio (**e a operação**...), desenvolvemos uma arquitetura que reduziu drasticamente o desperdício de produtos, trazendo uma **economia real e direta na casa dos milhões** para a margem de lucro.

Softwares bem arquitetados **(*É sério!, desenhem antes de fazer qualquer coisa*)** gera uma redução de custos e um lucro considerável **CONTANTO** que tenha pessoas que sejam **proativas** e **dedicadas** **(*e não tenham o ego inflado ao falar com pessoas menos técnicas*)** em ouvir a dor e transformar em solução, essa capacidade me deu algo que poucos possuem hoje no mercado de tecnologia, que é remover essa dor e transforma ela em produtividade e eficiência.
...
* **ExSign (Desenvolvedor Fullstack Junior):** Desenvolvimento de ponta a ponta com foco em interfaces modernas e integração eficiente de dados.
...
Além disso, tenho explorado **Inteligência Artificial** e **Node-RED** para otimizar processos da operação, como análise de imagem via pipeline **(*ninguém tem 24GB de VRAM livres para rodar Llama Vision, pobreza leva a queues*)**, treinamento de agentes para entender que um "*salgadinho não é um ovo*" **(*mais chato de fazer do que parece*)** e **AR (*Realidade Aumentada*)** — que ajuda, segundo os feedbacks que recebi, a operação a atuar com maior precisão e eficiência **(*realmente, fazer um funcionário apontar uma câmera e coletar o material, é muito mais eficiente do que coletar um por um, mas nem tudo é flores, equipamentos para isso são realmente caros ...*)**.
